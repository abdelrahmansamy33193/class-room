        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://www.instagram.com/classrooom/" target="_blank" rel="noopener noreferrer" className="hover:text-accent transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-3 text-sm text-muted-foreground">
                ...
                <span>Al-Hijrah District, Third Ring Road, Makkah 21241, Saudi Arabia</span>
              </li>
              ...
              <li className="flex items-center space-x-3 text-sm text-muted-foreground">
                ...
                <span>info@classroomfurniture.sa</span>
              </li>
            </ul>
          </div>
